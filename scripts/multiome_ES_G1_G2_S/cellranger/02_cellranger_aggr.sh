...
#SBATCH -p long
#SBATCH --output=log/02_cellranger_aggr_ES_G1_G2_S-slurm-%j.log
...
cellranger-arc aggr \
    ...
    --csv=/well/beagrie/users/ysx978/projects/cell_cycle_phase_multiomics/out_ES_G1_G2_S/multiome/cellranger/aggregation.csv \
    --normalize=depth \
    --localcores=4 \
    --localmem=60
