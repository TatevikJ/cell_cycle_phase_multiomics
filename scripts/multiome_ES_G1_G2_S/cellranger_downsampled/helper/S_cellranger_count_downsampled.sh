...
#SBATCH -p long
#SBATCH --output=log/S_cellranger_count_downsampled-slurm-%j.out   # %j will be replaced with the Job ID
...
cellranger-arc count \
	       ...
	       --libraries=/well/beagrie/users/ysx978/projects/cell_cycle_phase_multiomics/out_ES_G1_G2_S/multiome/cellranger_downsampled/S_${n}_libraries.csv \
	       --localcores=8 \
	       --localmem=40
#done
