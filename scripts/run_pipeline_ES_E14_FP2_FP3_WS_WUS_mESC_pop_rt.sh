...
#SBATCH -p long
#SBATCH --output=log/run_pipeline_ES_E14_FP2_FP3_WS_WUS_mESC_pop_rt-slurm-%j.out   # %j will be replaced with the Job ID
...
bash scripts/pipeline.sh \
     ...
     "out/pipeline_out/out_ES_E14_FP2_FP3_WS_WUS_mESC_pop_rt"
